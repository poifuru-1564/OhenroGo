...
<html lang="en">
    ...
    <body>
       ...
       <div class="side-buttons">
            <div class="upper-side-buttons">
                <a href="!#"><button class="side-button">Published Blogs</button></a>
                <a href="!#"><button class="side-button">Draft Blogs</button></a>
                <a href="!#"><button class="side-button">Delete Account</button></a>
            </div>
